...
(function e(t, n, r) {
    function s(o, u) {
        ...
        function checkElem(elem, selector) {
            ...
            return selector ? match ? match[2] ? elem.id == match[2] : match[3] ? elem.nodeName == match[3].toUpperCase() : match[4] ? _hasClass(elem, match[4]) : false : false : true;
        }
        ...
        module.exports = {
             ...
             * @returns {string}
             */
            limitBytes: function limitBytes(lineBytes, max, bol, n) {
                n = n == null ? '<br/>' : n;
                var count = 0;
