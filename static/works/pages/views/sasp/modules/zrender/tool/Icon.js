...
define(function (require) {
    ...
    function _iconHeart(ctx, style) {
        var HeartShape = require('zrender/graphic/shape/Heart');
    ...
    function _iconDroplet(ctx, style) {
        var DropletShape = require('zrender/graphic/shape/Droplet');
    ...
    var Base = require('zrender/graphic/Path');
    ...
    Icon.prototype =  {
        ...
        isCover : function (x, y) {
            ...
            if (!rect) {
                rect = this.__rect = this.getRect(this.style);
            }
