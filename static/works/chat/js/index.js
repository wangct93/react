...
var _defaultState = __webpack_require__(53);
...
var midReducers = loadModuleNames.map(function (item) {
    return __webpack_require__(55)("./" + item);
});
...
var store = (0, _redux.createStore)(function () {
    ...
    for (var i = 0; i < midReducers.length; i++) {
        var execFunc = midReducers[i];
        var result = execFunc(state, action);
        if (result) {
...
function addSocketEvent() {
    ...
    socket.onmessage = function (msg) {
        (0, _store.dispatch)(JSON.parse(msg.data));
    };
}
...
var _reactComponent2 = __webpack_require__(23);
...
var Container = function (_reactComponent) {
    _inherits(Container, _reactComponent);
    ...
    function Container() {
        ...
        _this.state = wt.extend(true, {}, _store2.default.getState());
        return _this;
    }
    ...
    _createClass(Container, [{
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'chat-content', ref: 'content' },
                            _react2.default.createElement(
                                'ul',
                                ...
                                this.state.textList.map(function (item, i) {
                                    if (item.type == 'addText') {
                                        return _react2.default.createElement(
                                            'li',
                                            { key: i, className: item.user.userid == _this2.state.info.userid ? 'recore-self' : '' },
                                            _react2.default.createElement(
                                                'div',
                        ...
                        _react2.default.createElement('div', { className: 'chat-input-box', contentEditable: true, ref: 'input' }),
                        _react2.default.createElement(
                            'div',
                            { className: 'chat-btn-box' },
                            _react2.default.createElement(
                                'a',
                                { className: 'chat-btn', onClick: this.sendText.bind(this) },
                                '\u53D1\u9001'
                            )
                        )
                    ),
        ...
        value: function componentWillMount() {
            ...
            _store2.default.subscribe(function (a, b) {
                var state = _store2.default.getState();
                if (!wt.equal(_this3.state, state)) {
                    _this3.setState(wt.extend(true, {}, state));
                }
            });
        }
    }, {
...
var m=__webpack_require__(8),n=__webpack_require__(3),p=__webpack_require__(1),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(2),l=__webpack_require__(10),B=__webpack_require__(11),C=__webpack_require__(1),ba=__webpack_require__(12),da=__webpack_require__(13),ea=__webpack_require__(14),fa=__webpack_require__(15),ia=__webpack_require__(16),D=__webpack_require__(3);
...
var _userPanels = __webpack_require__(54);
...
exports.QunPanel = exports.PersonPanel = undefined;
...
var _reactComponent5 = __webpack_require__(23);
...
var PersonPanel = exports.PersonPanel = function (_reactComponent) {
    _inherits(PersonPanel, _reactComponent);

    function PersonPanel() {
        _classCallCheck(this, PersonPanel);

        return _possibleConstructorReturn(this, (PersonPanel.__proto__ || Object.getPrototypeOf(PersonPanel)).apply(this, arguments));
    }

    _createClass(PersonPanel, [{
        key: 'render',
        value: function render() {
            var data = this.props.data;
            return _react2.default.createElement(List, { list: data.list, childComponent: PersonItem, panelIndex: data.index });
        }
    }]);

    return PersonPanel;
}(_reactComponent5.reactComponent);

var PersonItem = function (_reactComponent2) {
    _inherits(PersonItem, _reactComponent2);

    function PersonItem() {
        _classCallCheck(this, PersonItem);

        return _possibleConstructorReturn(this, (PersonItem.__proto__ || Object.getPrototypeOf(PersonItem)).apply(this, arguments));
    }
...
var List = function (_reactComponent3) {
    _inherits(List, _reactComponent3);
    ...
    _createClass(List, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.list.map(function (item, i) {
                    return _react2.default.createElement(
                        'li',
                        { key: i, className: item.selected ? 'active' : '', onClick: _this4.click.bind(_this4, i, _this4.props.panelIndex) },
                        _react2.default.createElement(
                            'div',
                            { className: 'classify-header' },
                            _react2.default.createElement('i', { className: 'iconfont icon-sanjiao' }),
                            item.name
                        ),
                        _react2.default.createElement(
                            'ul',
                            { className: 'classify-sub-list', onClick: function onClick(e) {
                                    e.stopPropagation();
                                } },
        ...
        key: 'click',
        value: function click(index, panelIndex) {
            (0, _store.dispatch)({
                type: 'userListExpand',
...
var QunPanel = exports.QunPanel = function (_reactComponent4) {
    _inherits(QunPanel, _reactComponent4);

    function QunPanel() {
        _classCallCheck(this, QunPanel);

        return _possibleConstructorReturn(this, (QunPanel.__proto__ || Object.getPrototypeOf(QunPanel)).apply(this, arguments));
    }

    _createClass(QunPanel, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
